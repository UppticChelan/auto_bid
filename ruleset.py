...
def format_cols_input(df, ruleset):
    ...
    if ruleset.input == 'big_query':
        df = df.rename(columns={"tracker_campaign_name": "Campaign Name", "tracker_campaign_id": "Campaign ID", "country_field":"Country", "clean_subpub":"Application ID", "d7":"d7_total_revenue", "installs":"Installs"})
